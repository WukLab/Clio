...
enum LEGOFPGA_OPCODE_REQ {
	...
	OP_REQ_KVS_READ = 0x60,
	OP_REQ_KVS_READ_REPL,
	OP_REQ_KVS_CREATE,
	OP_REQ_KVS_CREATE_REPL,
	OP_REQ_KVS_UPDATE,
	OP_REQ_KVS_UPDATE_REPL,
	OP_REQ_KVS_DELETE,
	OP_REQ_KVS_DELETE_REPL,

	OP_REQ_CACHE_INVALID = 0x70,
	OP_REQ_POINTER_CHASING,
