...
//--------------------------------------------------------------------------------
//Command: generate_target bd_eef4.bd
//Design : bd_eef4
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_eef4,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_eef4,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "vcu_ddr4_controller_v1_0_1_ddr4_0_microblaze_mcs.hwdef" *) 
module bd_eef4
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    TRACE_reg_write,
    TRACE_valid_instr);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN bd_eef4_Clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_eef4 lmb_bram_I bd_eef4 second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_eef4_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_eef4_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_eef4_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_eef4_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_eef4 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_eef4_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_eef4_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_eef4_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_eef4_second_lmb_bram_I_0 second_lmb_bram_I
