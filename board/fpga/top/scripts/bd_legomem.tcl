...
proc cr_bd_top_legomem { parentCell } {
  ...
  # Create ports
  set debugCounter [ create_bd_port -dir I -from 31 -to 0 debugCounter ]
  set debugTimeStamps_0 [ create_bd_port -dir I -from 31 -to 0 debugTimeStamps_0 ]
  set debugTimeStamps_1 [ create_bd_port -dir I -from 31 -to 0 debugTimeStamps_1 ]
  set debugTimeStamps_2 [ create_bd_port -dir I -from 31 -to 0 debugTimeStamps_2 ]
  set debugTimeStamps_3 [ create_bd_port -dir I -from 31 -to 0 debugTimeStamps_3 ]
  set debugTimeStamps_4 [ create_bd_port -dir I -from 31 -to 0 debugTimeStamps_4 ]
  ...
  # Create instance: data_to_soc, and set properties
  set data_to_soc [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 data_to_soc ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets LegoMemSystem_0_soc_ctrlIn] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins ila_6/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets LegoMemSystem_0_soc_dataIn] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins data_to_soc/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins ila_4/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets relnet_0_usr_rx_payload] [get_bd_intf_pins ila_0/SLOT_0_AXIS] [get_bd_intf_pins m_usr_data_fifo/S_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets s_usr_sess_fifo_M_AXIS] [get_bd_intf_pins ila_7/SLOT_0_AXIS] [get_bd_intf_pins s_usr_sess_fifo/M_AXIS]
  connect_bd_intf_net -intf_net udp_in_header_1 [get_bd_intf_ports udp_in_header] [get_bd_intf_pins relnet_0/in_header]
  connect_bd_intf_net -intf_net udp_in_payload_1 [get_bd_intf_ports udp_in_payload] [get_bd_intf_pins relnet_0/in_payload]
  ...
  connect_bd_net -net debugCounter_0_1 [get_bd_ports debugCounter] [get_bd_pins LegoMemSystem_0/debugCounter]
  connect_bd_net -net debugTimeStamps_0_0_1 [get_bd_ports debugTimeStamps_0] [get_bd_pins LegoMemSystem_0/debugTimeStamps_0]
  connect_bd_net -net debugTimeStamps_1_0_1 [get_bd_ports debugTimeStamps_1] [get_bd_pins LegoMemSystem_0/debugTimeStamps_1]
  connect_bd_net -net debugTimeStamps_2_0_1 [get_bd_ports debugTimeStamps_2] [get_bd_pins LegoMemSystem_0/debugTimeStamps_2]
  connect_bd_net -net debugTimeStamps_3_0_1 [get_bd_ports debugTimeStamps_3] [get_bd_pins LegoMemSystem_0/debugTimeStamps_3]
  connect_bd_net -net debugTimeStamps_4_0_1 [get_bd_ports debugTimeStamps_4] [get_bd_pins LegoMemSystem_0/debugTimeStamps_4]
  connect_bd_net -net debugTimeStamps_5_0_1 [get_bd_ports debugTimeStamps_5] [get_bd_pins LegoMemSystem_0/debugTimeStamps_5]
  connect_bd_net -net debugTimeStamps_6_0_1 [get_bd_ports debugTimeStamps_6] [get_bd_pins LegoMemSystem_0/debugTimeStamps_6]
