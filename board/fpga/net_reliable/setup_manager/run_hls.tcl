...
add_files	setup_manager_top.cpp	-cflags -I../../../../include/

# Specify the top-level function for synthesis
set_top		setup_manager
...
# Export IP block
export_design -format ip_catalog -display_name "setup_manager_hls" -description "manage connection setup and close signal" -vendor "Wuklab.UCSD" -version "1.0"
