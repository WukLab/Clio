...
add_files	filter_64_top.cpp	-cflags -I../../../../include/
...
# Export IP block
export_design -format ip_catalog -display_name "broadcast_filter" -description "filter broadcast packet" -vendor "Wuklab.UCSD" -version "1.0"
